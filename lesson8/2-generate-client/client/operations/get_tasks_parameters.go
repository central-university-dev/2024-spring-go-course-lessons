...
type GetTasksParams struct {
	...
	/* ShowDone.
	   ...
	   Признак получения уже выполенных задач
	*/
	ShowDone *bool
...
// WithShowDone adds the showDone to the get tasks params
func (o *GetTasksParams) WithShowDone(showDone *bool) *GetTasksParams {
	o.SetShowDone(showDone)
	return o
}

// SetShowDone adds the showDone to the get tasks params
func (o *GetTasksParams) SetShowDone(showDone *bool) {
	o.ShowDone = showDone
}
...
func (o *GetTasksParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ShowDone != nil {
		...
		// query param show_done
		var qrShowDone bool

		if o.ShowDone != nil {
			qrShowDone = *o.ShowDone
		}
		qShowDone := swag.FormatBool(qrShowDone)
		if qShowDone != "" {

			if err := r.SetQueryParam("show_done", qShowDone); err != nil {
				return err
			}
		}
	}
