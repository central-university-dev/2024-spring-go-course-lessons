...
/*TodoListAPI Демонстрационное API сервиса 'список задач' */
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["DELETE"]["/task/{taskId}"] = NewDeletePet(o.context, o.DeletePetHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/task/{taskId}"] = NewGetTaskByID(o.context, o.GetTaskByIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["PUT"]["/task/{taskId}"] = NewUpdateTask(o.context, o.UpdateTaskHandler)
}
